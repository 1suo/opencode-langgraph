...
export interface OpenCodeRuntimeOptions {
  ...
  onEvent?: (event: { node: string; status: string; agent: string; model: string; text?: string; state?: Record<string, unknown>; sessionId?: string; usage?: AgentUsage; streaming?: UsageStreamingEstimate; prompt?: AgentPromptTrace }) => void;
}
